      ...
      >
        ...
        <div className="flex items-center mx">
          ...
          <div className="hidden md:flex">
            <Link to={"/cart"}>
              <div className="inline-flex relative gap-2 items-center py-3 px-3 ms-2 text-sm font-medium text-white bg-primary rounded-full">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
               ...
               <span className="absolute flex -top-4 right-0 rounded-full bg-white p-2 text-primary"> {cartItems?.length??0}</span>
              </div> 
